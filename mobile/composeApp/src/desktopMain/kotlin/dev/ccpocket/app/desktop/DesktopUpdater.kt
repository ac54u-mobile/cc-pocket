...
object DesktopUpdater {
    ...
    fun upgradeCommandFor(source: DkInstallSource): String? = when (source) {
        DkInstallSource.BREW -> "curl -fsSL https://raw.githubusercontent.com/ac54u-mobile/cc-pocket/main/scripts/install.sh | bash"
        DkInstallSource.SCOOP -> "irm https://raw.githubusercontent.com/ac54u-mobile/cc-pocket/main/scripts/install.ps1 | iex"
        else -> null
    }
